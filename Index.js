const urlapi = "https://localhost:7294/swagger/index.html"
...
$(document).ready(function () {
    ...
    tablaData = $('#tbdata').DataTable({
        responsive: true,
        "ajax": {
            "url": 'https://localhost:7294/api/Contacto',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
$("#btnGuardar").click(function () {
    ...
    if (modelo.idContacto == 0) {
        ...
        fetch('https://localhost:7294/api/Contacto', {
            method: "POST",
            body: formData
        })
            .then(response => {
    ...
    swal({
        ...
        function (respuesta) {
            ...
            if (respuesta) {
                ...
                fetch(`https://localhost:7294/api/Contacto=${data.id}`, {
                    method: "DELETE"
                })
                    .then(response => {
